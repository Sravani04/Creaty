...
class MultiTouchListener implements OnTouchListener {
    ...
    MultiTouchListener(View deleteView, RelativeLayout parentView,
                       ImageView photoEditImageView, TextView addtext_btn, OnPhotoEditorSDKListener onPhotoEditorSDKListener) {
        mScaleGestureDetector = new ScaleGestureDetector(new ScaleGestureListener());
        this.deleteView = deleteView;
        this.parentView = parentView;
        this.photoEditImageView = photoEditImageView;
        this.addtext_btn = addtext_btn;
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (action & event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                } else if (!isViewInBounds(parentView, x, y)) {
                    view.animate().translationY(0).translationX(0);
                }
